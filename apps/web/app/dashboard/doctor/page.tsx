...
export default function DoctorDashboard() {
  ...
  return (
    <DashboardShell role="doctor" userName={session.user.name} title="Dashboard" subtitle="Your day at a glance">
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b flex items-center justify-between">
            ...
            <Link href="/dashboard/doctor/appointments" className="text-cyan-600 hover:text-cyan-700 text-sm font-semibold">
              See all
            </Link>
          </div>
