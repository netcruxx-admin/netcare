...
export default function PatientBabyPage() {
  ...
  if (!baby) {
    return (
      <DashboardShell role="patient" userName={session.user.name} title="My Baby">
  ...
  return (
    <DashboardShell role="patient" userName={session.user.name} title="My Baby" subtitle={`${baby.name} · ${ageDisplay(baby.dateOfBirth)}`}>
