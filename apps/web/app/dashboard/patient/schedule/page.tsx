...
export default function PatientSchedulePage() {
  ...
  return (
    <DashboardShell role="patient" userName={session.user.name} title="Schedule" subtitle="Your appointment calendar">
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Calendar */}
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-slate-900">Calendar</h3>
            <Link href="/dashboard/patient/book" className="inline-flex items-center gap-1.5 text-sm font-semibold text-cyan-600 hover:text-cyan-700">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="px-6 py-4 border-b flex items-center justify-between">
              ...
              <Link href="/dashboard/patient/appointments" className="text-sm text-cyan-600 hover:text-cyan-700 font-semibold flex items-center gap-1">
