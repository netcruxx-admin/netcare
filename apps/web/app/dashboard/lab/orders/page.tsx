...
function LabOrdersInner() {
  ...
  return (
    <DashboardShell role="lab" userName={session.user.name} title="Test Orders" subtitle="Process orders and publish results">
