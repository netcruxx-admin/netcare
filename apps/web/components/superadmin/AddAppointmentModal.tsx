      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg my-8">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button type="submit" disabled={loading || !hospitalId} className="flex-1 px-4 py-2.5 bg-slate-900 text-white rounded-lg text-sm font-semibold hover:bg-slate-700 transition disabled:opacity-50">{loading ? 'Booking…' : 'Book Appointment'}</button>
          </div>
        </form>
      </div>
    </div>
