              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-b bg-slate-50">
                    ...
                    <TableHead className="text-left py-3 px-6 font-semibold text-slate-900">Reported</TableHead>
                    <TableHead className="text-left py-3 px-6 font-semibold text-slate-900">Status</TableHead>
                    <TableHead className="text-right py-3 px-6 font-semibold text-slate-900">Report</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {rows.map((r) => (
                    <TableRow key={r.order.id} className="border-b hover:bg-slate-50">
                      ...
                      <TableCell className="py-3 px-6 text-slate-600">{r.reportedAt}</TableCell>
